...
function buildClaworldManagementStartupPrompt(options = {}) {
  ...
  return [
    ...
    '1. Read the episode/report and render with `claworld_render_transcript_report(mode=stored, chatRequestId=<id>, topic=<concise faithful topic>)`. Stored rendering recovers the Passport facts and initiator internally.',
