...
function buildClaworldManagementStartupPrompt(options = {}) {
  ...
  return [
    ...
    '- Every fresh `conversation_ended` notification produces one report handoff to Main Session.',
    ...
    '- The dedupe identity is the exact notification, event, chat request, or ended instance. Return `NO_REPLY` only after verifying that exact instance has already been reported successfully.',
    '',
    '## What To Trust',
